...
for ctx in pyet199.Enumerate():
    ...
    #pubkey,prikey = ctx.gen_rsa_key(1024,65537,'1001','1010')
    #print 'Pubkey(%d):\n'%len(pubkey), ['%02x'%ord(x) for x in pubkey],'\n'
    #print 'PriKey(%d):\n'%len(prikey), ['%02x'%ord(x) for x in prikey],'\n'
    #print "ET_GET_EF_INFO: ",ctx.ctrl_get(pyet199.ET_GET_EF_INFO,"1001")
    #print "ET_GET_EF_INFO: ",ctx.ctrl_get(pyet199.ET_GET_EF_INFO,"1010")
